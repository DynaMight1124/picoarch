...
static const struct core_override_option gambatte_core_option_overrides[] = {
	...
	},
	{
		...
		.options = {
			...
			[53] = { "TWB64 Pack 3",             "TWB64 3" },
			[54] = { "PixelShift Pack 1",        "PixelShift" },
		}
	},
	{
	...
	},
	{
		...
		.desc = "TWB64 Pack 3",
		.options = {
			{ "TWB64 201 - DMG-GOLD",                   "DMG-GOLD" },
			{ "TWB64 202 - LCD Clock Green",            "LCD Clock Green" },
			{ "TWB64 203 - Famicom Frenzy",             "Famicom Frenzy" },
			{ "TWB64 204 - DK Arcade Blue",             "DK Arcade Blue" },
			{ "TWB64 205 - Advanced Indigo",            "Advanced Indigo" },
			{ "TWB64 206 - Ultra Black",                "Ultra Black" },
			{ "TWB64 207 - Chaos Emerald Green",        "Chaos Emerald Green" },
			{ "TWB64 208 - Blue Bomber Vision",         "Blue Bomber Vision" },
			{ "TWB64 209 - Krispy Kreme Vision",        "Krispy Kreme Vision" },
			{ "TWB64 210 - Steam Gray",                 "Steam Gray" },
			{ "TWB64 211 - Dream Land GB Ver.",         "Dream Land GB Ver." },
			{ "TWB64 212 - Pokemon Pinball Ver.",       "Pokemon Pinball Ver." },
			{ "TWB64 213 - Poketch Ver.",               "Poketch Ver." },
			{ "TWB64 214 - COLLECTION of SaGa Ver.",    "COLLECTION of SaGa Ver." },
			{ "TWB64 215 - Rocky-Valley Holiday",       "Rocky-Valley Holiday" },
			{ "TWB64 216 - Giga Kiwi DMG",              "Giga Kiwi DMG" },
			{ "TWB64 217 - DMG Pea Green",              "DMG Pea Green" },
			{ "TWB64 218 - Timing Hero Ver.",           "Timing Hero Ver." },
			{ "TWB64 219 - Invincible Yellow and Blue", "Invincible Yellow and Blue" },
			{ "TWB64 220 - Grinchy Green",              "Grinchy Green" },
			{ "TWB64 221 - Animate vision",             "Animate vision" },
			{ "TWB64 222 - School Idol Mix",            "School Idol Mix" },
			{ "TWB64 223 - Green Awakening",            "Green Awakening" },
			{ "TWB64 224 - Goomba Brown",               "Goomba Brown" },
			{ "TWB64 225 - WarioWare MicroBlue",        "WarioWare MicroBlue" },
			{ "TWB64 226 - KonoSuba Sherbet",           "KonoSuba Sherbet" },
			{ "TWB64 227 - Spooky Purple",              "Spooky Purple" },
			{ "TWB64 228 - Treasure Gold",              "Treasure Gold" },
			{ "TWB64 229 - Cherry Blossom Pink",        "Cherry Blossom Pink" },
			{ "TWB64 230 - Golden Trophy",              "Golden Trophy" },
			{ "TWB64 231 - Glacial Winter Blue",        "Glacial Winter Blue" },
			{ "TWB64 232 - Leprechaun Green",           "Leprechaun Green" },
			{ "TWB64 233 - SAITAMA SUPER BLUE",         "SAITAMA SUPER BLUE" },
			{ "TWB64 234 - SAITAMA SUPER GREEN",        "SAITAMA SUPER GREEN" },
			{ "TWB64 235 - Duolingo Green",             "Duolingo Green" },
			{ "TWB64 236 - Super Mushroom Vision",      "Super Mushroom Vision" },
			{ "TWB64 237 - Ancient Hisuian Brown",      "Ancient Hisuian Brown" },
			{ "TWB64 238 - Sky Pop Ivory",              "Sky Pop Ivory" },
			{ "TWB64 239 - LAWSON BLUE",                "LAWSON BLUE" },
			{ "TWB64 240 - Anime Expo Red",             "Anime Expo Red" },
			{ "TWB64 241 - Brilliant Diamond Blue",     "Brilliant Diamond Blue" },
			{ "TWB64 242 - Shining Pearl Pink",         "Shining Pearl Pink" },
			{ "TWB64 243 - Funimation Melon",           "Funimation Melon" },
			{ "TWB64 244 - Teyvat Brown",               "Teyvat Brown" },
			{ "TWB64 245 - Chozo Blue",                 "Chozo Blue" },
			{ "TWB64 246 - Spotify Green",              "Spotify Green" },
			{ "TWB64 247 - Dr Pepper Red",              "Dr Pepper Red" },
			{ "TWB64 248 - NHK Silver Gray",            "NHK Silver Gray" },
			{ "TWB64 249 - Dunkin' Vision",             "Dunkin' Vision" },
			{ "TWB64 250 - Deku Gamma Palette",         "Deku Gamma Palette" },
			{ "TWB64 251 - Universal Studios Blue",     "Universal Studios Blue" },
			{ "TWB64 252 - Hogwarts Goldius",           "Hogwarts Goldius" },
			{ "TWB64 253 - Kentucky Fried Red",         "Kentucky Fried Red" },
			{ "TWB64 254 - Cheeto Orange",              "Cheeto Orange" },
			{ "TWB64 255 - Namco Idol Pink",            "Namco Idol Pink" },
			{ "TWB64 256 - Domino's Pizza Vision",      "Domino's Pizza Vision" },
			{ "TWB64 257 - Pac-Man Vision",             "Pac-Man Vision" },
			{ "TWB64 258 - Bill's PC Screen",           "Bill's PC Screen" },
			{ "TWB64 259 - Sonic Mega Blue",            "Sonic Mega Blue" },
			{ "TWB64 260 - Fool's Gold and Silver",     "Fool's Gold and Silver" },
			{ "TWB64 261 - UTA VISION",                 "UTA VISION" },
			{ "TWB64 262 - Metallic Paldea Brass",      "Metallic Paldea Brass" },
			{ "TWB64 263 - Classy Christmas",           "Classy Christmas" },
			{ "TWB64 264 - Winter Christmas",           "Winter Christmas" },
			{ "TWB64 265 - IDOL WORLD TRICOLOR!!!",     "IDOL WORLD TRICOLOR!!!" },
			{ "TWB64 266 - Inkling Tricolor",           "Inkling Tricolor" },
			{ "TWB64 267 - 7-Eleven Color Combo",       "7-Eleven Color Combo" },
			{ "TWB64 268 - PAC-PALETTE",                "PAC-PALETTE" },
			{ "TWB64 269 - Vulnerable Blue",            "Vulnerable Blue" },
			{ "TWB64 270 - Nightvision Green",          "Nightvision Green" },
			{ "TWB64 271 - Bandai Namco Tricolor",      "Bandai Namco Tricolor" },
			{ "TWB64 272 - Gold, Silver, and Bronze",   "Gold, Silver, and Bronze" },
			{ "TWB64 273 - Deku Vigilante Palette",     "Deku Vigilante Palette" },
			{ "TWB64 274 - Super Famicom Supreme",      "Super Famicom Supreme" },
			{ "TWB64 275 - Absorbent and Yellow",       "Absorbent and Yellow" },
			{ "TWB64 276 - 765PRO TRICOLOR",            "765PRO TRICOLOR" },
			{ "TWB64 277 - GameCube Glimmer",           "GameCube Glimmer" },
			{ "TWB64 278 - 1st Vision Pastel",          "1st Vision Pastel" },
			{ "TWB64 279 - Perfect Majin Emperor",      "Perfect Majin Emperor" },
			{ "TWB64 280 - J-Pop Idol Sherbet",         "J-Pop Idol Sherbet" },
			{ "TWB64 281 - Ryuuguu Sunset",             "Ryuuguu Sunset" },
			{ "TWB64 282 - Tropical Starfall",          "Tropical Starfall" },
			{ "TWB64 283 - Colorful Horizons",          "Colorful Horizons" },
			{ "TWB64 284 - BLACKPINK BLINK PINK",       "BLACKPINK BLINK PINK" },
			{ "TWB64 285 - DMG-SWITCH",                 "DMG-SWITCH" },
			{ "TWB64 286 - POCKET SWITCH",              "POCKET SWITCH" },
			{ "TWB64 287 - Sunny Passion Paradise",     "Sunny Passion Paradise" },
			{ "TWB64 288 - Saiyan Beast Silver",        "Saiyan Beast Silver" },
			{ "TWB64 289 - RADIANT SMILE RAMP",         "RADIANT SMILE RAMP" },
			{ "TWB64 290 - A-RISE BLUE",                "A-RISE BLUE" },
			{ "TWB64 291 - TROPICAL TWICE APRICOT",     "TROPICAL TWICE APRICOT" },
			{ "TWB64 292 - Odyssey Boy",                "Odyssey Boy" },
			{ "TWB64 293 - Frog Coin Green",            "Frog Coin Green" },
			{ "TWB64 294 - Garfield Vision",            "Garfield Vision" },
			{ "TWB64 295 - Bedrock Caveman Vision",     "Bedrock Caveman Vision" },
			{ "TWB64 296 - BANGTAN ARMY PURPLE",        "BANGTAN ARMY PURPLE" },
			{ "TWB64 297 - LE SSERAFIM FEARLESS BLUE",  "LE SSERAFIM FEARLESS BLUE" },
			{ "TWB64 298 - Baja Blast Beach",           "Baja Blast Beach" },
			{ "TWB64 299 - 3DS Virtual Console Green",  "3DS Virtual Console Green" },
			{ "TWB64 300 - Wonder Purple",              "Wonder Purple" },
			{ NULL, NULL },
		}
	},
	{
